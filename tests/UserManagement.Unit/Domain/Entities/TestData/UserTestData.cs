...
namespace UserManagement.Unit.Domain.Entities.TestData;
...
public static class UserTestData
{
    ...
    public static PhoneNumber GenerateInvalidPhone()
    {
        var phoneNumberValue = new Faker().Random.AlphaNumeric(5);
